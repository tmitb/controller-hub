...
public class GeneralRequests : BaseRequests
{
    ...
    /// <summary>Broadcasts a `CustomEvent` to all WebSocket clients. - Complexity Rating: `1/5` - Latest Supported RPC Version: `1` - Added in v5.0.0</summary>
    ...
    /// <summary>Call a request registered to a vendor. - Complexity Rating: `3/5` - Latest Supported RPC Version: `1` - Added in v5.0.0</summary>
    ...
    /// <summary>Gets an array of all hotkey names in OBS. - Complexity Rating: `4/5` - Latest Supported RPC Version: `1` - Added in v5.0.0</summary>
    public Task<JObject> GetHotkeyListAsync()
    => _bridge.SendRequestAsync("GetHotkeyList", new JObject());
    /// <summary>Triggers a hotkey using its name. - Complexity Rating: `4/5` - Latest Supported RPC Version: `1` - Added in v5.0.0</summary>
    ...
    /// <summary>Triggers a hotkey using a sequence of keys. - Complexity Rating: `4/5` - Latest Supported RPC Version: `1` - Added in v5.0.0</summary>
    public Task<JObject> TriggerHotkeyByKeySequenceAsync(string keyId = null, JObject keyModifiers = null)
    {
        ...
        if (keyModifiers != null && keyModifiers.GetValue("shift") != null) data["keyModifiers.shift"] = JToken.FromObject(keyModifiers.GetValue("shift"));
        if (keyModifiers != null && keyModifiers.GetValue("control") != null) data["keyModifiers.control"] = JToken.FromObject(keyModifiers.GetValue("control"));
        if (keyModifiers != null && keyModifiers.GetValue("alt") != null) data["keyModifiers.alt"] = JToken.FromObject(keyModifiers.GetValue("alt"));
        if (keyModifiers != null && keyModifiers.GetValue("command") != null) data["keyModifiers.command"] = JToken.FromObject(keyModifiers.GetValue("command"));
        return _bridge.SendRequestAsync("TriggerHotkeyByKeySequence", data);
    }
    /// <summary>Sleeps for a time duration or number of frames. - Complexity Rating: `2/5` - Latest Supported RPC Version: `1` - Added in v5.0.0</summary>
