...
public sealed class RealRawGamepadProvider : IGamepadProvider
{
    ...
    private ControllerHub.Models.ControllerState _previousState;
    ...
    public event Action<ControllerHub.Models.ControllerDelta> StateChanged;
    ...
    private void Poll(object state)
    {
        ...
        try
        {
            ...
            var currentState = new ControllerHub.Models.ControllerState();
